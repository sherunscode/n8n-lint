...
expect(
  ...
  "package.json quality gate must include lint, format, schema config, type hygiene, pre-commit, community readiness, release readiness, README demo, security hygiene, docs contract, package content, claims hygiene, markdown link, and exit-code checks"
);
