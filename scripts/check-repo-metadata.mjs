...
expect(
  packageJson.scripts?.["check:public-source-checkout"] === "node scripts/check-public-source-checkout.mjs",
  "package.json must expose the public source-checkout checker"
);
expect(
...
await expectFile(".github/workflows/release.yml");
...
await expectFile("scripts/check-public-source-checkout.mjs");
  ...
  JSON.stringify(
    {
      ...
      checked: [
        ...
        "scripts/check-public-source-checkout.mjs",
