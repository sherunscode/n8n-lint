...
release-readiness verification, live REST boundary verification, README demo
verification, animated-demo verification, social-preview verification,
audit-report verification, status-doc verification, README/CLI docs-contract
