...
| E19 | `docs/assets/github-pr-merge-gate-proof.png`            | Real GitHub PR checks-tab screenshot captured from proof-only PR #5. Freshness is enforced by `npm run check:github-pr-gate-proof`, which validates the PNG plus public GitHub metadata for failed `quality`, successful CodeQL, unstable merge state, closed PR state, and deleted proof branch cleanup.                                                                                                                                                                                                      |
