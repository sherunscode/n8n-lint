...
The quality path covers build, lint, format, example/schema checks, security hygiene, README/CLI docs-contract checks, package-content checks, tests, and production dependency audit.
