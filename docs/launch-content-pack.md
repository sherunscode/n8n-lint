...
No fake stars, fake followers, bought engagement, bots, spam, or misleading
authorship.

Current non-claims mirror `tool.json`: npm registry publication, live REST
schema validation, workflow execution, hosted SaaS, and GitHub Marketplace
listing.
...
| E2  | `npm run quality` from `C:\dev\Stars`                   | Passed build, ESLint, Prettier format check, example check, bundled-schema check, schema-config check, type-hygiene check, pre-commit hook contract check, precommit-rejection demo check, community-readiness check, release-readiness check, live REST boundary check, launch-content check, benchmark-report check, benchmark-dashboard check, batch benchmark output check, GitHub Action contract check, GitHub PR gate proof check, GitHub-rendered README check, GitHub profile check, GitHub repo settings check, clean source-checkout check, public source-checkout check, README demo check, animated-demo check, terminal-output demo check, matrix-demo check, matrix GIF check, social-preview check, audit-report check, status-doc check, metadata check, security hygiene check, README/CLI docs-contract check, package-content check, claims hygiene check, Markdown link check, executable exit-code contract, core fixture tests, CLI fixture tests, production dependency audit with 0 vulnerabilities, and packed-install smoke. |
| E2A | `npm run check:clean-source-checkout`                   | Exports tracked source files into a temporary clean checkout, runs `npm ci`, runs `npm run build`, follows the README quickstart, verifies a failing fixture exits nonzero, and runs packed-install smoke outside the working copy. This proves the source-checkout path only; registry-backed `npx n8n-lint` remains gated until npm publication. |
| E2B | `npm run check:public-source-checkout`                  | Clones the public GitHub repo, runs `npm ci`, runs `npm run build`, follows the README quickstart, and runs packed-install smoke when local `HEAD` matches public `main`. PR branches skip until merged; registry-backed `npx n8n-lint` remains gated until npm publication. |
...
| E9A | `docs/release-notes-v0.1.0-draft.md`                    | Draft GitHub Release notes are prepared but owner-gated; `npm run check:release-notes` reconciles them against benchmark counts, quality proof, publish order, rollback boundaries, and current non-claims.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| E9B | `docs/release-command-plan-v0.1.0.md`                   | Dry-run release command contract is prepared but owner-gated; `npm run check:release-command-plan` reconciles public-state preflight, final quality checks, package publish order, registry smoke, single-tag GitHub Release creation, forbidden commands, and rollback boundaries.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| E9C | `npm run check:npm-registry-boundary`                   | Pre-publication registry proof checks both publishable package names, `@n8nproof/core` and `n8n-lint`, and requires npm `E404` while registry publication remains unclaimed.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| E10 | `git remote -v`                                         | Canonical repo remote is `https://github.com/sherunscode/n8n-lint.git`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| E11 | `docs/assets/social-preview.svg` and `docs/assets/social-preview.png` | Generated from the current benchmark report, bundled schema config, and canonical repo metadata by `npm run generate:social-preview`; freshness is enforced by `npm run check:social-preview`. The PNG is the GitHub repository settings upload asset and is checked at 1280x640 under 1 MB.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| E12 | `docs/assets/animated-failure-demo.svg`                 | Generated from actual failing CLI output by `npm run generate:animated-demo`; freshness is enforced by `npm run check:animated-demo`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| E13 | `docs/assets/terminal-output-demo.svg`                  | Generated from actual colored pass and fail CLI output by `npm run generate:terminal-output-demo`; freshness is enforced by `npm run check:terminal-output-demo`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| E18 | `docs/assets/batch-benchmark-output.svg`                | Generated from `docs/benchmark-zie619-report.json` by `npm run generate:batch-benchmark-output`; freshness is enforced by `npm run check:batch-benchmark-output`. It shows the checked full-repo batch benchmark output, discovered/selected/pass/fail/skipped counts, top failure categories, and the no-workflow-execution/no-live-REST boundary.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| E19 | `docs/assets/github-pr-merge-gate-proof.png`            | Real GitHub PR checks-tab screenshot captured from proof-only PR #6. Freshness is enforced by `npm run check:github-pr-gate-proof`, which validates the PNG plus public GitHub metadata for failed required `quality`, successful CodeQL, protected `BLOCKED` merge state, closed PR state, deleted proof branch cleanup, and `main` branch protection requiring `quality` with admin bypass disabled.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
6. Use `docs/assets/social-preview.svg` and `docs/assets/social-preview.png`
   only after `npm run check:social-preview` passes on the same commit.
7. Use `docs/assets/animated-failure-demo.svg` only after
   `npm run check:animated-demo` passes on the same commit.
8. Use `docs/assets/matrix-compatibility-demo.svg` and
   `docs/assets/matrix-compatibility-demo.gif` only after
   `npm run check:matrix-demo` and `npm run check:matrix-gif` pass on the same
   commit.
9. Use `docs/assets/matrix-compatibility-demo.svg` only after
...
12. Use `docs/assets/batch-benchmark-output.svg` only after
    `npm run check:batch-benchmark-output` passes on the same commit.
13. Use `docs/assets/github-pr-merge-gate-proof.png` only after
    `npm run check:github-pr-gate-proof` passes on the same commit.
14. Use `docs/assets/terminal-output-demo.svg` only after
    `npm run check:terminal-output-demo` passes on the same commit.
15. Use `docs/assets/precommit-rejection-demo.svg` only after
    `npm run check:precommit-rejection-demo` passes on the same commit.
16. Do not mention stars, followers, installs, traffic, or engagement unless a
    current source is attached.
17. Run `npm run check:launch-content` before approving any launch copy changes.
