...
| E11 | `docs/assets/social-preview.svg`                        | Generated from the current benchmark report, bundled schema config, and canonical repo metadata by `npm run generate:social-preview`; freshness is enforced by `npm run check:social-preview`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
