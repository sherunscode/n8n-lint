...
11. Do not mention stars, followers, installs, traffic, or engagement unless a
   current source is attached.
12. Run `npm run check:launch-content` before approving any launch copy changes.
