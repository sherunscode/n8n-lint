...
- Local quality gates prove build, lint, format, fixtures, metadata, security
  hygiene, schema-config integrity, type hygiene, README/CLI docs contract,
  package contents, claims hygiene, Markdown link integrity, executable
  exit-code behavior, tests, and production dependency audit status.
